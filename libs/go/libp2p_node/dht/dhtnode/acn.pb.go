...
type AcnMessage_StatusCode_StatusCodeEnum int32

const (
	// common (0x)
	AcnMessage_StatusCode_SUCCESS                   AcnMessage_StatusCode_StatusCodeEnum = 0
	AcnMessage_StatusCode_ERROR_UNSUPPORTED_VERSION AcnMessage_StatusCode_StatusCodeEnum = 1
	AcnMessage_StatusCode_ERROR_UNEXPECTED_PAYLOAD  AcnMessage_StatusCode_StatusCodeEnum = 2
	AcnMessage_StatusCode_ERROR_GENERIC             AcnMessage_StatusCode_StatusCodeEnum = 3
	AcnMessage_StatusCode_ERROR_SERIALIZATION       AcnMessage_StatusCode_StatusCodeEnum = 4
	// register (1x)
	AcnMessage_StatusCode_ERROR_WRONG_AGENT_ADDRESS AcnMessage_StatusCode_StatusCodeEnum = 10
	AcnMessage_StatusCode_ERROR_WRONG_PUBLIC_KEY    AcnMessage_StatusCode_StatusCodeEnum = 11
	AcnMessage_StatusCode_ERROR_INVALID_PROOF       AcnMessage_StatusCode_StatusCodeEnum = 12
	AcnMessage_StatusCode_ERROR_UNSUPPORTED_LEDGER  AcnMessage_StatusCode_StatusCodeEnum = 13
	// lookup & delivery (2x)
	AcnMessage_StatusCode_ERROR_UNKNOWN_AGENT_ADDRESS AcnMessage_StatusCode_StatusCodeEnum = 20
	AcnMessage_StatusCode_ERROR_AGENT_NOT_READY       AcnMessage_StatusCode_StatusCodeEnum = 21
)

// Enum value maps for AcnMessage_StatusCode_StatusCodeEnum.
var (
	AcnMessage_StatusCode_StatusCodeEnum_name = map[int32]string{
		0:  "SUCCESS",
	...
	AcnMessage_StatusCode_StatusCodeEnum_value = map[string]int32{
		"SUCCESS":                     0,
...
func (x AcnMessage_StatusCode_StatusCodeEnum) Enum() *AcnMessage_StatusCode_StatusCodeEnum {
	p := new(AcnMessage_StatusCode_StatusCodeEnum)
	*p = x
	return p
}

func (x AcnMessage_StatusCode_StatusCodeEnum) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AcnMessage_StatusCode_StatusCodeEnum) Descriptor() protoreflect.EnumDescriptor {
	return file_acn_proto_enumTypes[0].Descriptor()
}

func (AcnMessage_StatusCode_StatusCodeEnum) Type() protoreflect.EnumType {
	return &file_acn_proto_enumTypes[0]
}

func (x AcnMessage_StatusCode_StatusCodeEnum) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AcnMessage_StatusCode_StatusCodeEnum.Descriptor instead.
func (AcnMessage_StatusCode_StatusCodeEnum) EnumDescriptor() ([]byte, []int) {
...
type AcnMessage_StatusCode struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ErrorCode AcnMessage_StatusCode_StatusCodeEnum `protobuf:"varint,1,opt,name=error_code,json=errorCode,proto3,enum=aea.aea.acn.v1_0_0.AcnMessage_StatusCode_StatusCodeEnum" json:"error_code,omitempty"`
}

func (x *AcnMessage_StatusCode) Reset() {
	*x = AcnMessage_StatusCode{}
	if protoimpl.UnsafeEnabled {
...
func (x *AcnMessage_StatusCode) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AcnMessage_StatusCode) ProtoMessage() {}

func (x *AcnMessage_StatusCode) ProtoReflect() protoreflect.Message {
	mi := &file_acn_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AcnMessage_StatusCode.ProtoReflect.Descriptor instead.
func (*AcnMessage_StatusCode) Descriptor() ([]byte, []int) {
	return file_acn_proto_rawDescGZIP(), []int{0, 1}
}

func (x *AcnMessage_StatusCode) GetErrorCode() AcnMessage_StatusCode_StatusCodeEnum {
	if x != nil {
		return x.ErrorCode
	}
	return AcnMessage_StatusCode_SUCCESS
}
...
func (x *AcnMessage_Aea_Envelope_Performative) GetBytes() []byte {
	if x != nil {
		return x.Bytes
	}
	return nil
...
type AcnMessage_Status_Performative struct {
	...
	Code *AcnMessage_StatusCode `protobuf:"bytes,1,opt,name=code,proto3" json:"code,omitempty"`
	Msgs string                 `protobuf:"bytes,2,opt,name=msgs,proto3" json:"msgs,omitempty"`
}
...
func (x *AcnMessage_Status_Performative) GetCode() *AcnMessage_StatusCode {
	if x != nil {
		return x.Code
	}
	return nil
...
func (x *AcnMessage_Status_Performative) GetMsgs() string {
	if x != nil {
		return x.Msgs
	}
	return ""
...
var file_acn_proto_rawDesc = []byte{
	...
	0xf6, 0x0c, 0x0a, 0x0a, 0x41, 0x63, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x5d,
	...
	,
	...
	,
	...
	,
}
...
var file_acn_proto_goTypes = []interface{}{
	(AcnMessage_StatusCode_StatusCodeEnum)(0),       // 0: aea.aea.acn.v1_0_0.AcnMessage.StatusCode.StatusCodeEnum
	(*AcnMessage)(nil),                              // 1: aea.aea.acn.v1_0_0.AcnMessage
	(*AcnMessage_AgentRecord)(nil),                  // 2: aea.aea.acn.v1_0_0.AcnMessage.AgentRecord
	(*AcnMessage_StatusCode)(nil),                   // 3: aea.aea.acn.v1_0_0.AcnMessage.StatusCode
...
var file_acn_proto_depIdxs = []int32{
	...
	0,  // 5: aea.aea.acn.v1_0_0.AcnMessage.StatusCode.error_code:type_name -> aea.aea.acn.v1_0_0.AcnMessage.StatusCode.StatusCodeEnum
	...
	3,  // 9: aea.aea.acn.v1_0_0.AcnMessage.Status_Performative.code:type_name -> aea.aea.acn.v1_0_0.AcnMessage.StatusCode
...
func file_acn_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_acn_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcnMessage_StatusCode); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
