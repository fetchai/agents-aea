...
``` bash
aea fetch fetchai/tac_controller:0.26.0
cd tac_controller
aea install
aea build
```
...
aea add skill fetchai/tac_control:0.22.0
...
``` bash
aea fetch fetchai/tac_participant:0.28.0 --alias tac_participant_one
cd tac_participant_one
aea install
aea build
cd ..
aea fetch fetchai/tac_participant:0.28.0 --alias tac_participant_two
