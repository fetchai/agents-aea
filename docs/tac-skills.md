...
``` bash
aea fetch fetchai/tac_controller:0.30.3
cd tac_controller
aea install
aea build
```
...
aea add skill fetchai/tac_control:0.25.4
...
``` bash
aea fetch fetchai/tac_participant:0.32.3 --alias tac_participant_one
cd tac_participant_one
aea install
aea build
cd ..
aea fetch fetchai/tac_participant:0.32.3 --alias tac_participant_two
