...
``` bash
aea fetch fetchai/weather_station:0.26.0 --alias my_weather_station
...
aea add skill fetchai/weather_station:0.23.0
...
``` bash
aea fetch fetchai/weather_client:0.27.0 --alias my_weather_client
...
aea add connection fetchai/soef:0.21.0
aea add connection fetchai/ledger:0.17.0
aea add skill fetchai/weather_client:0.23.0
aea config set --type dict agent.dependencies \
'{
  "aea-ledger-fetchai": {"version": "<2.0.0,>=1.0.0"}
}'
