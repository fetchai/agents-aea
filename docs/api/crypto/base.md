...
<a name="aea.crypto.base.LedgerApi.contract_method_call"></a>
...
<a name="aea.crypto.base.LedgerApi.build_transaction"></a>
#### build`_`transaction
...
<a name="aea.crypto.base.LedgerApi.get_transaction_transfer_logs"></a>
