AEAs can create and update prometheus metrics for remote monitoring by sending messages to the prometheus connection `fetchai/prometheus:0.5.0`.
...
``` bash
aea fetch fetchai/coin_price_feed:0.10.0
cd coin_price_feed
aea install
aea build
aea run
