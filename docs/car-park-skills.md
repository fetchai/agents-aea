...
1. Add a new AEA called `car_detector` with public id `fetchai/car_detector:0.32.2`.

2. Add another new AEA called `car_data_buyer` with public id `fetchai/car_data_buyer:0.33.2`.
