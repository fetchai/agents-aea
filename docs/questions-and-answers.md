...
All AEA projects by default hold the `fetchai/stub:0.5.0` connection, the `fetchai/default:0.3.0` protocol and the `fetchai/error:0.2.0` skill. These (as all other packages installed from the registry) are placed in the vendor's folder.
<br><br>
