...
All AEA projects by default hold the <code>fetchai/default:1.1.3</code>, <code>fetchai/state_update:1.1.3</code> and <code>fetchai/signing:1.1.2</code> protocols. These (as all other packages installed from the registry) are placed in the <code>vendor</code> folder. 
<br><br>
