The current version of the Python based Autonomous Economic Agent framework is <a href="https://img.shields.io/pypi/v/aea">PyPI</a>. The framework is under rapid development with frequent breaking changes.
