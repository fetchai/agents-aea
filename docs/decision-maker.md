...
The framework implements a default <a href="../api/decision_maker/default#decisionmakerhandler-objects">`DecisionMakerHandler`</a> and an advanced <a href="https://valory-xyz.github.io/open-aea/aea/api/decision_maker/gop/#decisionmakerhandler-objects" target="_blank">`DecisionMakerHandler`</a>. You can also implement your own and mount it.
