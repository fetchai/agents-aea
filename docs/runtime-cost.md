...
- the cost of basic components: dialogues mememory relative to number of messages, SOEF connection baseline memory usage, p2p connection baseline memory usage, smart contract baseline memory usage
