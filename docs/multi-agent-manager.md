...
weather_station_id = PublicId.from_str("fetchai/weather_station:0.29.0")
weather_client_id = PublicId.from_str("fetchai/weather_client:0.30.0")
...
p2p_public_id = PublicId.from_str("fetchai/p2p_libp2p:0.23.0")
soef_public_id = PublicId.from_str("fetchai/soef:0.24.0")
