...
``` bash
aea fetch fetchai/aries_alice:0.13.0
cd aries_alice
```
...
aea add connection fetchai/http_client:0.11.0
aea add connection fetchai/webhook:0.9.0
aea add skill fetchai/aries_alice:0.10.0
```
</p>
</details>
...
``` bash
aea fetch fetchai/aries_faber:0.13.0
cd aries_faber
```
...
aea add connection fetchai/http_client:0.11.0
aea add connection fetchai/webhook:0.9.0
aea add skill fetchai/aries_faber:0.9.0
```
</p>
</details>
