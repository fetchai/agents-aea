...
#
#
# class TestRunFailsWhenIdentifierNotInSupportedCryptos:
#     """Test that the command 'aea run' fails when an exception occurs in any skill."""
#
#     @classmethod
#     def setup_class(cls):
...
#
#         try:
#             json_mock = type('obj', (object,), {'test': 'dummy'})
#             mock_private_key_paths = [("dummy1", type('obj', (object,), {'json': json_mock}))]
#             with unittest.mock.patch('aea.configurations.base.CRUDCollection.read_all', return_value=mock_private_key_paths):
#                 cli.main([*CLI_LOG_OPTION, "run", "--connection", "local"])
#         except SystemExit as e:
#             cls.exit_code = e.code
#
...
#
#         try:
#             # class mock_key_paths:
#             #     def read_all(self):
#             #         return ("dummy1", "dummy2")
#             # with unittest.mock.patch.object(aea.configurations.base.AgentConfig, 'private_key_paths', mock_key_paths):
#             # json_mock = type('obj', (object,), {'test': 'dummy'})
#             # mock_private_key_paths = [("dummy1", type('obj', (object,), {'json': json_mock}))]
#             # with unittest.mock.patch('aea.configurations.base.CRUDCollection.read_all', return_value=mock_private_key_paths):
#                 cli.main([*CLI_LOG_OPTION, "run", "--connection", "local"])
