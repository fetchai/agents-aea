...
class TestExtractSpecification(TestCase):
    ...
    def test_extract_positive(self):
        ...
        assert spec.speech_acts == {
            "performative_ct": {"content_ct": "DataModel7"},
            "performative_empty_contents": {},
            "performative_mt": {
                "content_union_1": "Union[DataModel2, bytes, int, float, "
                ...
                "content_union_3": "Union[DataModel3, DataModel4, bytes]",
            },
            "performative_o": {
                "content_o_bool": "Optional[bool]",
                "content_o_ct": "Optional[DataModel5]",
            ...
            "performative_pct": {
                ...
                "content_list_ct": "Tuple[DataModel6, ...]",
                "content_list_ct2": "Tuple[DataModel3, ...]",
            ...
            "performative_pmt": {
                ...
                "content_dict_int_ct2": "Dict[int, DataModel2]",
        ...
        assert spec.all_unique_contents == {
            ...
            "content_set_str": "FrozenSet[str]",
            "content_str": "str",
            "content_union_1": "Union[DataModel2, bytes, int, float, bool, str, "
