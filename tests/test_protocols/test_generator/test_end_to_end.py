...
class TestEndToEndGenerator(UseOef):
    ...
    def test_generated_protocol_end_to_end(self):
        ...
        builder_1.set_default_connection(PublicId.from_str("fetchai/oef:0.8.0"))
        ...
        builder_2.set_default_connection(PublicId.from_str("fetchai/oef:0.8.0"))
        ...
        # create AEAs
        aea_1 = builder_1.build(connection_ids=[PublicId.from_str("fetchai/oef:0.8.0")])
        aea_2 = builder_2.build(connection_ids=[PublicId.from_str("fetchai/oef:0.8.0")])
