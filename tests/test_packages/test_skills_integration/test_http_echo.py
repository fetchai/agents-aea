...
class TestHttpEchoSkill(AEATestCaseEmpty):
    ...
    def test_echo(self):
        ...
        self.add_item("connection", "fetchai/http_server:0.19.0")
        self.add_item("skill", "fetchai/http_echo:0.17.0")
        self.set_config("agent.default_connection", "fetchai/http_server:0.19.0")
        self.set_config(
            "vendor.fetchai.connections.http_server.config.target_skill_id",
            "fetchai/http_echo:0.17.0",
        )
        self.set_config(
