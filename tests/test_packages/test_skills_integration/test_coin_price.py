...
class TestCoinPriceSkill(AEATestCaseEmpty):
    ...
    def test_coin_price(self):
        ...
        self.add_item("connection", "fetchai/http_server:0.20.0")
        self.add_item("connection", "fetchai/prometheus:0.6.0")
        self.add_item("skill", "fetchai/advanced_data_request:0.3.0")
        self.set_config("agent.default_connection", "fetchai/http_server:0.20.0")
        ...
        self.set_config(
            ...
            "fetchai/advanced_data_request:0.3.0",
        )
        self.set_config(
        ...
        diff = self.difference_to_fetched_agent(
            "fetchai/coin_price_feed:0.11.0", coin_price_feed_aea_name
        )
        assert (
            diff == []
