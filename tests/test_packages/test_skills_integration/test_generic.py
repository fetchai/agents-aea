...
class TestGenericSkills(AEATestCaseManyFlaky):
    ...
    def test_generic(self, pytestconfig):
        ...
        self.add_item("skill", "fetchai/generic_seller:0.28.3")
        setting_path = (
        ...
        self.set_config("agent.default_connection", "fetchai/p2p_libp2p:0.27.2")
        self.add_item("connection", "fetchai/ledger:0.21.2")
        self.add_item("skill", "fetchai/generic_buyer:0.27.3")
        setting_path = (
...
class TestGenericSkillsFetchaiLedger(AEATestCaseManyFlaky):
    ...
    def test_generic(self, pytestconfig):
        ...
        diff = self.difference_to_fetched_agent(
            "fetchai/generic_seller:0.29.2", seller_aea_name
        )
        assert (
            diff == []
        ...
        diff = self.difference_to_fetched_agent(
            "fetchai/generic_buyer:0.30.2", buyer_aea_name
        )
        assert (
            diff == []
        ), "Difference between created and fetched project for files={}".format(diff)
