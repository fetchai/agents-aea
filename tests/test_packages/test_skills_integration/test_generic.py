...
class TestGenericSkills(AEATestCaseManyFlaky):
    ...
    def test_generic(self, pytestconfig):
        ...
        self.add_item("skill", "fetchai/generic_seller:0.22.0")
        setting_path = (
        ...
        self.set_config("agent.default_connection", "fetchai/p2p_libp2p:0.18.0")
        self.add_item("connection", "fetchai/ledger:0.15.0")
        self.add_item("skill", "fetchai/generic_buyer:0.22.0")
        setting_path = (
...
class TestGenericSkillsFetchaiLedger(AEATestCaseManyFlaky):
    ...
    def test_generic(self, pytestconfig):
        ...
        diff = self.difference_to_fetched_agent(
            "fetchai/generic_seller:0.21.0", seller_aea_name
        )
        assert (
            diff == []
        ...
        diff = self.difference_to_fetched_agent(
            "fetchai/generic_buyer:0.22.0", buyer_aea_name
        )
        assert (
            diff == []
        ), "Difference between created and fetched project for files={}".format(diff)
