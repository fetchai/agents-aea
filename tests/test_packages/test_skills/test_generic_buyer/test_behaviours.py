...
class TestTransactionBehaviour(BaseSkillTestCase):
    ...
    def test_act_i(self):
        ...
        # setup
        _, fipa_dialogue = self._setup_fipa_ledger_api_dialogues()
        ...
        # _start_processing
        self._check_start_processing_effects(fipa_dialogue, mock_logger)
    ...
    def test_act_iii(self):
        """Test the act method of the transaction behaviour where processing is NOT None and processing_time > max_processing."""
        # setup
        ledger_api_dialogue, fipa_dialogue = self._setup_fipa_ledger_api_dialogues()
