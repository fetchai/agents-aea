...
class TProtocolSerializer(Serializer):
    ...
    def encode(cls, msg: Message) -> bytes:
        ...
        if performative_id == TProtocolMessage.Performative.PERFORMATIVE_CT:
            ...
            if msg.is_set("content_union_3_type_DataModel"):
                performative.content_union_3_type_DataModel_is_set = True
                content_union_3_type_DataModel = msg.content_union_3_type_DataModel
                DataModel.encode(
                    performative.content_union_3_type_DataModel,
                    content_union_3_type_DataModel,
                )
            if msg.is_set("content_union_3_type_DataModel2"):
                performative.content_union_3_type_DataModel2_is_set = True
                content_union_3_type_DataModel2 = msg.content_union_3_type_DataModel2
                DataModel2.encode(
