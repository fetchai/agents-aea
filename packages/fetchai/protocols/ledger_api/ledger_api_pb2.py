...
_LEDGERAPIMESSAGE_ARGS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="args",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.Args.args",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_LEDGERAPIMESSAGE_STATE = _descriptor.Descriptor(
    name="State",
    full_name="aea.fetchai.ledger_api.LedgerApiMessage.State",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="state",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.State.state",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_LEDGERAPIMESSAGE_GET_STATE_PERFORMATIVE = _descriptor.Descriptor(
    ...
    full_name="aea.fetchai.ledger_api.LedgerApiMessage.Get_State_Performative",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="ledger_id",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.Get_State_Performative.ledger_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="callable",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.Get_State_Performative.callable",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="args",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.Get_State_Performative.args",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_LEDGERAPIMESSAGE_STATE_PERFORMATIVE = _descriptor.Descriptor(
    ...
    full_name="aea.fetchai.ledger_api.LedgerApiMessage.State_Performative",
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    fields=[
        _descriptor.FieldDescriptor(
            name="ledger_id",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.State_Performative.ledger_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="state",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.State_Performative.state",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_LEDGERAPIMESSAGE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="get_state",
            full_name="aea.fetchai.ledger_api.LedgerApiMessage.get_state",
            index=4,
            number=9,
            type=11,
            cpp_type=10,
...
_LEDGERAPIMESSAGE_ARGS.containing_type = _LEDGERAPIMESSAGE
...
_LEDGERAPIMESSAGE_GET_STATE_PERFORMATIVE.fields_by_name[
    "args"
].message_type = _LEDGERAPIMESSAGE_ARGS
...
LedgerApiMessage = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        Args=_reflection.GeneratedProtocolMessageType(
            "Args",
            (_message.Message,),
            dict(
                DESCRIPTOR=_LEDGERAPIMESSAGE_ARGS,
                __module__="ledger_api_pb2"
                # @@protoc_insertion_point(class_scope:aea.fetchai.ledger_api.LedgerApiMessage.Args)
            ),
        ),
        ...
        State=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="ledger_api_pb2"
                # @@protoc_insertion_point(class_scope:aea.fetchai.ledger_api.LedgerApiMessage.State)
            ),
        ),
        ...
        Get_State_Performative=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="ledger_api_pb2"
                # @@protoc_insertion_point(class_scope:aea.fetchai.ledger_api.LedgerApiMessage.Get_State_Performative)
            ),
        ),
        State_Performative=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="ledger_api_pb2"
                # @@protoc_insertion_point(class_scope:aea.fetchai.ledger_api.LedgerApiMessage.State_Performative)
            ),
        ),
...
_sym_db.RegisterMessage(LedgerApiMessage.Args)
