...
_FIPAMESSAGE_PROPOSE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="tx_nonce",
            full_name="fetch.aea.fipa.FIPAMessage.Propose.tx_nonce",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
