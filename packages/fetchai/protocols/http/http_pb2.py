...
_HTTPMESSAGE_REQUEST_PERFORMATIVE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="query",
            full_name="fetch.aea.Http.HttpMessage.Request_Performative.query",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
