...
# source: protocols/oef_search/oef_search.proto
    ...
    dict(
        Description=_reflection.GeneratedProtocolMessageType(
            ...
            dict(
                ...
                __module__="protocols.oef_search.oef_search_pb2"
