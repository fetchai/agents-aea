    ...
    (_message.Message,),
    {
        "Observation_Performative": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                # @@protoc_insertion_point(class_scope:aea.fetchai.aggregation.v0_2_6.AggregationMessage.Observation_Performative)
            },
        ),
        "Aggregation_Performative": _reflection.GeneratedProtocolMessageType(
            ...
            (_message.Message,),
            {
                ...
                "__module__": "aggregation_pb2"
                # @@protoc_insertion_point(class_scope:aea.fetchai.aggregation.v0_2_6.AggregationMessage.Aggregation_Performative)
            },
        ),
        "DESCRIPTOR": _AGGREGATIONMESSAGE,
        "__module__": "aggregation_pb2"
        # @@protoc_insertion_point(class_scope:aea.fetchai.aggregation.v0_2_6.AggregationMessage)
    },
)
