...
First, add the connection to your AEA project: `aea add connection fetchai/p2p_libp2p:0.20.0`.
...
If the delegate service is enabled, then other AEAs can connect to the peer node using the `fetchai/p2p_libp2p_client:0.16.0` connection.
