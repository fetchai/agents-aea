...
## Usage
First, add the connection to your AEA project: `aea add connection fetchai/stub:0.14.0`. (If you have created your AEA project with `aea create` then the connection will already be available by default.)
