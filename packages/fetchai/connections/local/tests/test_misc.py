...
def make_local_connection(
    ...
    oef_local_connection = OEFLocalConnection(
        ...
        data_dir=unittest.mock.MagicMock(),
...
def test_connection():
    ...
    with LocalNode() as node:
        ...
        multiplexer2 = Multiplexer(
            [make_local_connection("multiplexer2", "my_public_key_2", node)]
        )
...
async def test_connection_twice_return_none():
    ...
    with LocalNode() as node:
        ...
        connection = make_local_connection(address, public_key, node)
...
def test_communication():
    ...
    with LocalNode() as node:
        ...
        multiplexer2 = Multiplexer(
            [make_local_connection("multiplexer2", "multiplexer1_public_key", node)]
        )
