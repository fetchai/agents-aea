...
class FIPAHandler(Handler):
    ...
    def handle(self, message: Message, sender: str) -> None:
        ...
        if dialogues.is_belonging_to_registered_dialogue(fipa_msg, sender, self.context.agent_public_key):
            ...
            dialogue = dialogues.create_opponent_initiated(dialogue_id, sender)
            dialogue.incoming_extend(fipa_msg)
        else:
    ...
    def _handle_accept(self, msg: FIPAMessage, sender: str, message_id: int, dialogue_id: int,
    ...
    def _handle_inform(self, msg: FIPAMessage, sender: str, message_id: int, dialogue_id: int,
                       dialogue: Dialogue) -> None:
        """
        Handle the INFORM.
