...
class FIPAHandler(Handler):
    ...
    def handle(self, message: Message) -> None:
        ...
        if dialogues.is_belonging_to_registered_dialogue(fipa_msg, self.context.agent_public_key):
            ...
            dialogue = cast(Dialogue, dialogues.create_opponent_initiated(dialogue_opponent_pbk=message.counterparty,
    ...
    def _handle_accept(self, msg: FIPAMessage, message_id: int,
    ...
    def _handle_inform(self, msg: FIPAMessage, message_id: int,
                       dialogue: Dialogue) -> None:
        """
        Handle the INFORM.
