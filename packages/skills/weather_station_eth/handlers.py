...
if TYPE_CHECKING:
    from packages.skills.weather_station_eth.dialogues import Dialogue, Dialogues
    from packages.skills.weather_station_eth.strategy import Strategy
else:
    from weather_station_eth_skill.dialogues import Dialogue, Dialogues
    from weather_station_eth_skill.strategy import Strategy
...
class FIPAHandler(Handler):
    ...
    def _handle_accept(self, msg: FIPAMessage, sender: str, message_id: int, dialogue_id: int, dialogue: Dialogue) -> None:
        ...
        match_accept_msg = FIPAMessage(message_id=new_message_id,
                                       ...
                                       address=self.context.agent_addresses['ethereum'])
