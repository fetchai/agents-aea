...
from packages.fetchai.skills.weather_client_ledger.dialogues import Dialogue, Dialogues
from packages.fetchai.skills.weather_client_ledger.strategy import Strategy
...
class MyTransactionHandler(Handler):
    ...
    def handle(self, message: Message) -> None:
        ...
        if tx_msg_response is not None and \
            ...
            self.context.outbox.put_message(to=counterparty_addr,
                                            sender=self.context.agent_address,
                                            protocol_id=FIPAMessage.protocol_id,
