...
class Parameters(BaseParameters):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._contract_init_tx_fee = kwargs.pop("contract_init_tx_fee", DEFAULT_CONTRACT_INIT_FEE)  # type: int
        self._contract_deploy_tx_fee = kwargs.pop("contract_deploy_tx_fee", DEFAULT_CONTRACT_DEPLOY_FEE)  # type: int
        self._contract_execute_tx_fee = kwargs.pop("contract_execute_tx_fee", DEFAULT_CONTRACT_EXECUTE_FEE)  # type: int
