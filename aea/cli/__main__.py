...
def create(click_context, agent_name):
    ...
    try:
        ...
        agent_config = AgentConfig(agent_name=agent_name, aea_version=aea.__version__, authors="", version="v1", license="", url="", registry_path="../packages", private_key_pem_path="", description="")
