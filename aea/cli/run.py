...
from aea.exceptions import AEANoDefaultLedgerException, AEAWalletNoAddressException
...
def _build_aea(
    ...
    try:
        ...
        return aea
    except AEANoDefaultLedgerException:
        error_msg = "No default ledger specified. Please use 'aea config set agent.default_ledger LEDGER_ID'"
