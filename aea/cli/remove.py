...
class ItemRemoveHelper:
    ...
    def get_agent_dependencies_with_reverse_dependencies(
        ...
        Return example:
        {
            PackageId(protocol, fetchai/default:0.8.0): {
                PackageId(skill, fetchai/echo:0.10.0),
                PackageId(skill, fetchai/error:0.8.0)
            },
            PackageId(connection, fetchai/stub:0.12.0): set(),
            PackageId(skill, fetchai/error:0.8.0): set(),
            PackageId(skill, fetchai/echo:0.10.0): set()}
        )
        """
