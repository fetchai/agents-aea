...
def create(click_context, agent_name):
    ...
    try:
        ...
        agent_config = AgentConfig(agent_name=agent_name, aea_version=aea.__version__, user_name="", version="v1", license="", url="", registry_path=DEFAULT_REGISTRY_PATH, description="")
