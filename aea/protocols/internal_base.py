...
class ProtobufSerializer(Serializer):
    ...
    def decode(self, obj: bytes) -> InternalMessage:
        ...
        body = dict(body_json)
        msg = InternalMessage(body=body)
        return msg


class JSONSerializer(Serializer):
    """
    Default serialization in JSON for the InternalMessage object.

    It assumes that the InternalMessage contains a JSON-serializable body.
    """
    ...
    def decode(self, obj: bytes) -> InternalMessage:
        ...
        return InternalMessage(json_msg)
...
class Protocol(ABC):
    ...
    def check(self, msg: InternalMessage) -> bool:
        """
