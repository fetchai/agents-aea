...
_DEFAULTMESSAGE_BYTES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="content",
            full_name="fetch.aea.Default.DefaultMessage.Bytes.content",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_DEFAULTMESSAGE_ERROR_ERRORDATAENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="key",
            full_name="fetch.aea.Default.DefaultMessage.Error.ErrorDataEntry.key",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="fetch.aea.Default.DefaultMessage.Error.ErrorDataEntry.value",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_DEFAULTMESSAGE_ERROR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="error_code",
            full_name="fetch.aea.Default.DefaultMessage.Error.error_code",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="error_msg",
            full_name="fetch.aea.Default.DefaultMessage.Error.error_msg",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="error_data",
            full_name="fetch.aea.Default.DefaultMessage.Error.error_data",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_DEFAULTMESSAGE_ERROR.fields_by_name[
    "error_code"
].message_type = _DEFAULTMESSAGE_ERRORCODE
_DEFAULTMESSAGE_ERROR.fields_by_name[
    "error_data"
].message_type = _DEFAULTMESSAGE_ERROR_ERRORDATAENTRY
