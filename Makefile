...
.PHONY: test
test:
	pytest -rfE plugins/fetchai-crypto/tests --cov=fetchai_crypto --cov-report=term --cov-report=term-missing --cov-config=.coveragerc
	pytest -rfE plugins/ethereum-crypto/tests --cov=ethereum_crypto --cov-report=term --cov-report=term-missing --cov-config=.coveragerc
	pytest -rfE plugins/cosmos-crypto/tests --cov=cosmos_crypto --cov-report=term --cov-report=term-missing --cov-config=.coveragerc
