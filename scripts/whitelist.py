...
_.get_quantity_in_decision_maker_outbox  # unused method (aea/test_tools/test_skills.py:69)
_.get_message_from_decision_maker_outbox  # unused method (aea/test_tools/test_skills.py:73)
