...
class RAIL_DATAMODEL(DataModel):
    ...
    def __init__(self):
        ...
        self.ATTRIBUTE_LOCATION = Attribute("latlon", Location, True)

        super().__init__(
            "rail_data_model", [self.ATTRIBUTE_COUNTRY, self.ATTRIBUTE_CITY, self.ATTRIBUTE_LOCATION]
        )
